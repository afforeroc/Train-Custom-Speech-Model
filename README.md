...
# Deploy web app (as a custom app) on IBM Cloud

Instructions for deploying the web application (as a custom app) on Cloud Foundry can be found [here](doc/cloud-deploy-custom.md).
